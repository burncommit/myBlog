...
import com.example.myBlog.dto.MemberRequest;
...
public class MemberController {
    ...
    @GetMapping("/signup")
    public String signup(MemberRequest memberRequest){return "signup_form";}
    ...
    public String signup(@Valid MemberRequest memberRequest, BindingResult bindingResult){
        ...
        if(!memberRequest.getPassword1().equals(memberRequest.getPassword2())){
            bindingResult.rejectValue("password2", "passIncorrect", "2개의 패스워드가 일치하지 않습니다");
            return "signup_form";
        }
